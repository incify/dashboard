			...
			<div class="box">
				...
				<div class="box-body clearfix">
					...
					<div class="ui-image-radio mb-5">
							...
							<h6>BTC</h6>
							<?php echo e(Form::radio('Currency', 'BTC',true)); ?>
							...
							<h6>ETH</h6>
							<?php echo e(Form::radio('Currency', 'ETH')); ?>
							...
							<h6>LTC</h6>
							<?php echo e(Form::radio('Currency', 'LTC')); ?>
							...
							<h6>BCH</h6>
							<?php echo e(Form::radio('Currency', 'BCH')); ?>
					...
					<div class="form-group mb-2">
						...
						<div class="input-group">
							<?php echo e(Form::text('curency_quality',null,array('id' => 'OnChange1','class' => 'form-control','required' => 'required'))); ?><span class="input-group-addon label_curency_text">BTC</span>
						</div>
					</div>
					<div class="form-group mb-2">
					...
					<div class="col-md-12 clearfix">
                                    <div class="pull-left text-right">
                                        <p><?php echo e($token_name); ?> amount to buy:</p>
                                        <p><span class="label_curency_text">BTC</span> to pay:</p>
                                        <p><span class="discount-percent badge red"><?php echo e($token_bonus); ?>%</span> Bonus:</p>
                                        <p>Total:</p>
                                    </div>
                                    <div class="pull-right">
                                        <p><b class="token_buy">0</b> <?php echo e($token_name); ?></p>
                                        <p><b class="currency_buy">0</b> <span class="label_curency_text">BTC</span></p>
                                        <p><b class="token_bonus">0</b> <?php echo e($token_name); ?></p>
                                        <p><b class="total_token">0</b> <?php echo e($token_name); ?></p>
                                    </div>
                                </div>
