			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="input-group mb-2">
						<span class="input-group-addon">BTC</span> {{ Form::number('btc_quality',null,array('id' => 'btc_input','class' => 'form-control')) }}
					</div>
					<div class="input-group mb-2">
						<span class="input-group-addon">NOVA</span> {{ Form::number('token_quality',null,array('id' => 'token_input','class' => 'form-control')) }}
					</div>
					{{ Form::close() }}
				</div>
			</div>
