	...
	<div class="row">
		<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2">
			<div class="box">
				...
				<div class="box-body">
					{{ Form::open(array('id' => 'refresh','url' => 'foo/bar')) }}
					...
					<div class="form-group mb-2">
						...
						<div class="input-group">
							{{ Form::number('curency_quality',null,array('id' => 'OnChange1','class' => 'form-control')) }}<span class="input-group-addon label_curency_text">BTC</span>
						</div>
					</div>
					<div class="form-group mb-2">
						<label>Amount of {{$token_name}} to buy</label>
						<div class="input-group">
							{{ Form::number('token_quality',null,array('id' => 'OnChange2','class' => 'form-control')) }}<span class="input-group-addon">{{$token_name}}</span>
						</div>
					</div>
