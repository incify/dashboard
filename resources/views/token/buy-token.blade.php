...
<div class="padding">
	<div class="row">
		<div class="col-lg-8 offset-lg-2">
			<div class="box">
				<div class="box-header d-flex"><h3>Select preferred payment method</h3></div>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-9 bhoechie-tab-container clearfix">
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
						...
						<div class="bhoechie-tab-content active">
							...
							{{ Form::label('btc', 'Sum to Spend, BTC') }}
							{{ Form::number('btc_quality',null,array('id' => 'btc_input','class' => 'form-control')) }}
							{{ Form::label('token', 'Amount of NOVA to buy') }}
							{{ Form::number('token_quality',null,array('id' => 'token_input','class' => 'form-control')) }}
							{{ Form::close() }}
						</div>
						<!-- train section -->
